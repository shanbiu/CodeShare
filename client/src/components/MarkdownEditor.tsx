...
export function MarkdownEditor({ markdown, setMarkdown }: MarkdownEditorProps) {
  ...
  const buttons = [
    {
      title: "标题",
      icon: <span className="font-bold text-base">H</span>,
    ...
    },
    {
      title: "链接",
      icon: <LinkOutlined />,
      action: () => insertMarkdown("[链接文字](", ")"),
    },
    {
      title: "图片",
      icon: <PictureOutlined />,
      action: () => insertMarkdown("![图片描述](", ")"),
    },
    {
      title: "代码块",
      icon: <CodeOutlined />,
  ...
  return (
    <div>
      {/* 工具栏容器 */}
      <div
        className="flex justify-between items-center space-x-2 border border-b-0 border-neutral-200  overflow-x-auto
