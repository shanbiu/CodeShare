...
// 配置 Monaco 编辑器的语言支持
function MonacoEditor({ language, code, onChange }: { language: string; code: string; onChange: (value: string) => void }) {
  ...
  useEffect(() => {
    ...
    monaco.languages.setMonarchTokensProvider('java', {
      tokenizer: {
        root: [
          [/\b(?:public|private|class|interface|return|void|package)\b/, 'keyword'],
